...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" id="target" action="{{ route('store') }}" enctype="multipart/form-data">
                    @csrf
                        <!-- User -->
                        <div class="card">
                            <div class="card-header bg-primary text-white">
                                ...
                                <center>Ingresar información</center>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username"  tabindex="1"   autocomplete="username" autofocus>
                                            @error('username')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name"  tabindex="1"  autocomplete="name" autofocus>
                                            @error('name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="website" type="text" class="form-control @error('website') is-invalid @enderror" name="website"  tabindex="1"  autocomplete="website" autofocus>
                                            @error('website')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="company" type="text" class="form-control @error('company') is-invalid @enderror" name="company"  tabindex="1"  autocomplete="company" autofocus>
                                            @error('company')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email"  tabindex="1"  autocomplete="email" autofocus>
                                            @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address"  tabindex="1" autocomplete="address" autofocus>
                                            @error('address')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone"  tabindex="1"   autocomplete="phone" autofocus>
                                            @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group">
                                        <center>
                                            <button type="submit" id="crearUsuario" class="btn btn-primary">Adicionar</button>
                                        </center>
                                    </div>
                                </div>
                            </div>
...
<script>
    function addposts(){
       ...
       $('#myTablepost').append('<tr><td>'+addpostnumber+'</td><td><input type="text" name="titlepost'+addpostnumber+'" value='+titlepost+' disabled></td><td><input type="text" name="bodypost'+addpostnumber+'" value='+bodypost+' disabled></td><td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalviewcometario" ><i class="fa fa-eye"></i></button></td><td><button type="button" class="btn btn-success" data-toggle="modal" data-target="#modaladdcometario"><i class="fa fa-plus"></i></button></td></tr>');
    ...
    function addalbums(){
       ...
       $('#myTablealbum').append('<tr><td>'+addalbumnumber+'</td><td><input type="text" name="titlealbum'+addalbumnumber+'" value='+titlealbum+' disabled><td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalviewphotos"><i class="fa fa-eye"></i></button></td><td><button type="button" class="btn btn-success" data-toggle="modal" data-target="#modaladdphotos"><i class="fa fa-plus"></i></button></td></tr>');
    ...
    function addcomentarios(){
       ...
       $('#myTablecomentraio').append('<tr><td>'+addcomentarionumber+'</td><td><input type="text" name="namecomment'+addcomentarionumber+'" value='+namecomment+' disabled></td><td><input type="text" name="emailcomment'+addcomentarionumber+'" value='+emailcomment+' disabled></td><td><input type="text" name="bodycomment'+addcomentarionumber+'" value='+bodycomment+' disabled></td></tr>');
    ...
    function addphoto(){
       ...
       $('#myTablephoto').append('<tr><td>'+addphotonumber+'</td><td><input type="text" name="titlephoto'+addphotonumber+'" value='+titlephoto+' disabled></td><td><input type="text" name="urlphoto'+addphotonumber+'" value='+urlphoto+' disabled></td><td><input type="text" name="thumbanialurlphoto'+addphotonumber+'" value='+thumbanialurlphoto+' disabled></td></tr>');
